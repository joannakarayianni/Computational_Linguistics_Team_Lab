...
""" DeBERTA model trained for multilabel emotion classification """
class DebertModel:
...
# Deberta Model used 
        ...
        self.deberta_model = TFDebertaForSequenceClassification.from_pretrained('microsoft/deberta-base', num_labels=len(emotions))
...
# tokenizing text data into DeBERTa-compatible input ids & attention masks
...
# Building the model
    def build_model(self):
        ...
        bert_output = self.deberta_model(input_ids, attention_mask=attention_mask).logits
...
# evaluation on test set
    ...
    def predict_test(self):
        ...
        predictions_df.to_csv('scripts/advanced_classifier/lstm/predictions/predictions_deberta.csv', index=False)
        # print report
...
classifier = DebertModel(train_path, val_path, test_path, emotions)
